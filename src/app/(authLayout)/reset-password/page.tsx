    ...
    <div className="w-full max-w-lg mx-auto bg-white dark:bg-[#111116] border border-zinc-100 dark:border-zinc-800/40 rounded-xl p-8 shadow-xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-text-primary mt-1">
          ...
          <span className="font-semibold text-primary">{email}</span> and your
          new password.
        </p>
      </div>
      ...
      <form onSubmit={handleReset} className="space-y-4">
        ...
        <div className="space-y-0">
          ...
          <Input
            ...
            type="text"
            placeholder="000000"
            className="w-full bg-white dark:bg-[#111116] border-zinc-200/80 dark:border-zinc-800/80 text-base tracking-[0.5em] font-bold text-center py-2 transition-all focus-visible:ring-2"
            maxLength={6}
            value={otp}
